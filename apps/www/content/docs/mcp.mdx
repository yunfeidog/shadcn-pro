---
title: shadcn-pro MCP Server
description: Learn how to use the Model Context Protocol with shadcn-pro.
date: 2025-04-16
---

shadcn-pro now has an official MCP server 🎉.

[MCP](https://modelcontextprotocol.com/) is an open protocol that standardizes how applications provide context to LLMs.

This is useful for shadcn-pro because you can now give your AI-assisted IDE direct access to all shadcn-pro components so that it can generate code with minimal errors.
...
You can now ask your IDE to use any shadcn-pro component. Here are some examples:
