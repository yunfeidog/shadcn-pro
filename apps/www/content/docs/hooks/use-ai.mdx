...
```bash
npx shadcn@latest add https://shadcn-pro.vercel.app/r/use-ai.json
```
...
- **📊 State Management**: Built-in loading, error, and message states
- **🛡️ Error Handling**: Automatic error detection and retry logic
- **⚡ TypeScript**: Full type safety with comprehensive type definitions
- **🎛️ Customizable**: Flexible configuration with custom headers and callbacks
